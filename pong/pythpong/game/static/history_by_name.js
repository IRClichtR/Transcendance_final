...
const tournament_history = JSON.parse(document.getElementById('tournament_history').textContent);
console.log(tournament_history);
const gameHistory = document.getElementById('game-history');


tournament_history.data.forEach(game => {
    if (game[3] === playerName || game[4] === playerName || game[5] === playerName || game[6] === playerName) {
