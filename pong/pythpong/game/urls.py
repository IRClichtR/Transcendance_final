...
app_patterns = [
    ...
    path('play/<int:game_id>/<int:player_id>/<str:player_name>/', play_game, name='play_game'),
    ...
    path('waiting_room/<str:player_name>/', waiting_room_by_name, name='waiting_room_by_name'),
